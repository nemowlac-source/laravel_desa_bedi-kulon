<x-layouts.admin>
    ...
    <div class="card bg-white shadow max-w-3xl mx-auto p-6">
        ...
        <form action="{{ route('potensi.update', $potensi->id) }}" method="POST" enctype="multipart/form-data" id="form-potensi-edit">
            @csrf @method('PUT')
            ...
            <div class="form-control mb-4">
                ...
                <div class="mt-2">
                    ...
                    <img src="{{ asset('storage/' . $potensi->gambar) }}" class="h-20 rounded border mt-1">
                </div>
            </div>
            ...
            <div class="form-control mb-6">
                ...
                <div id="editor-container">{!! $potensi->deskripsi !!}</div>

                <input type="hidden" name="deskripsi" id="deskripsi_potensi">
            </div>

            <button type="submit" class="btn btn-warning w-full text-white">Update Data</button>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var form = document.getElementById('form-potensi-edit');
