    ...
    <div class="card bg-white shadow max-w-3xl mx-auto p-6">
        ...
        <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" id="form-berita">
            ...
            <div class="form-control mb-4">
                ...
                <input type="file" name="gambar" class="file-input file-input-bordered bg-white" accept="image/*" required>
            </div>
            ...
            <button type="submit" class="btn btn-primary w-full text-white">Terbitkan Berita</button>
        </form>
    </div>
