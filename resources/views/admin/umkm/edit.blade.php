<x-layouts.admin>
    ...
    <div class="card bg-white shadow max-w-2xl mx-auto p-6">
        ...
        <form action="{{ route('umkm.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="upload-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-control mb-3">
                ...
                <div class="mt-2">
                    ...
                    <img src="{{ asset('storage/' . $product->gambar_thumbnail) }}" class="h-20 rounded border" onerror="this.src='{{ asset('storage/' . $product->gambar) }}'">
                </div>
            </div>
            ...
            <div id="loading-state" class="hidden mb-4">
                <div class="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-blue-800">Memperbarui produk...</p>
            ...
            <button class="btn btn-warning w-full text-white" id="btn-submit">Update Produk</button>
        </form>
    </div>
