    ...
    <section class="profile-page">
        <div class="profile-container">
            ...
            <div class="vision-card">
                ...
                <p class="vision-text">
                    “Desa Bedi Kulon sebagai Desa Wisata yang mampu mengelola potensi Desa dan pembangunan berkelanjutan untuk mewujudkan masyarakat yang sejahtera”
                </p>
            </div>
            ...
            <div class="bagan-grid">
                <div class="bagan-item">
                    ...
                    <div class="bagan-image-wrapper">
                        <img src="bagan-pemerintahan.jpg" alt="Struktur Organisasi Pemerintahan Desa">
                    </div>
                </div>
                ...
                <div class="bagan-item">
                    ...
                    <div class="bagan-image-wrapper">
                        <img src="bagan-bpd.jpg" alt="Struktur Organisasi BPD">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="lokasi-grid">
                ...
                <div class="lokasi-data">
                    <div class="data-statistik">
                        <div class="stat-box">
                            ...
                            <span class="value">22,23 km²</span>
                        </div>
                        <div class="stat-box">
                            <span class="label">Jumlah Penduduk</span>
                            <span class="value">1.162 Jiwa</span>
                        </div>
                    </div>
                    ...
                    <div class="batas-box">
                        <h3>Batas Wilayah</h3>
                        <ul>
                            <li><strong>Utara:</strong> Selat Makassar</li>
                            <li><strong>Selatan:</strong> Desa Semangko</li>
                            <li><strong>Barat:</strong> Kecamatan Muara Badak</li>
                            <li><strong>Timur:</strong> Selat Makassar</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="lokasi-map">
                    <div class="map-responsive">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15959.23123456789!2d117.4883772!3d-0.052557!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df6f5e5dd0019c1%3A0x18940f09946a3cf3!2sKantor%20Desa%20Bedi Kulon!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid"
